    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon" 
          className="lg:hidden h-12 w-12 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 hover:scale-110 transition-all duration-300 border border-white/20 min-h-[44px] min-w-[44px] active:scale-95" 
      ...
      <SheetContent 
        side="left" 
        className="w-56 max-w-[50vw] bg-gradient-to-b from-pink-50 to-white p-0 border-r-2 border-pink-200 h-full overflow-y-auto flex flex-col"
      >
        <SheetHeader className="p-2 bg-gradient-to-r from-pink-400 to-pink-500 border-b border-pink-300">
          <div className="flex items-center justify-between">
            ...
            <SheetClose asChild>
              <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-white hover:bg-white/20 rounded-full border border-white/30 bg-red-500">
